...
Weirdly enough, my plot seems to be reversed from the example Marina gave. When your sample is >30 then it can almost look like a normal distribution.
...
The graph increasingly looks unimodal with 16 samples.
...
With 25 samples, again it increasingly looks unimodal compared to 16 and 9.
...
We showed the Central Line Theorem through a series of plots that, as the sample got bigger, increasibly looked unimodal.
